...
Namespace IPControl
    ...
    Public Class CommandException
        ...
        ''' Gets the error kind.
        ''' </summary>
        Public ReadOnly Property ErrorKind As ErrorKind
            Get
                Return _errorKind
            End Get
        End Property
        ...
        Public Sub New(errorKind As ErrorKind, errorDescription As String)
            MyBase.New(errorDescription)
            _errorKind = errorKind
        End Sub

        Public Sub New(errorKind As ErrorKind, errorDescription As String, inner As Exception)
        ...
        Protected Sub New(info As SerializationInfo, context As StreamingContext)
            ...
            If info IsNot Nothing Then
                _errorKind = DirectCast(info.GetValue("_errorKind", GetType(IPControl.ErrorKind)), IPControl.ErrorKind)
            End If
        End Sub
        ...
        Public Overrides Function ToString() As String
            Return ErrorKind.ToString & ": " & Message
        End Function
    End Class
