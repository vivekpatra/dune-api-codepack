...
Namespace Extensions
    ...
    Public Module StringExtensions
        ...
        ''' </summary>
        <Extension()>
        Public Function IsNotNullOrEmpty(ByVal text As String) As Boolean
        ...
        ''' </summary>
        <Extension()>
        Public Function IsNotNullOrWhiteSpace(ByVal text As String) As Boolean
        ...
        ''' </summary>
        <Extension()>
        Public Function Left(ByVal text As String, ByVal length As Integer) As String
        ...
        ''' </summary>
        <Extension()>
        Public Function Right(ByVal text As String, ByVal length As Integer) As String
