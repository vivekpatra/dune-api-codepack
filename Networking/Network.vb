...
Namespace Networking
    ...
    Public Class NetworkInterfaceInfo
        ...
        Public Shared Function FromHost(host As IPAddress) As NetworkInterfaceInfo
            Return New NetworkInterfaceInfo With {
                .Address = host,
                .PhysicalAddress = ArpRequest.GetResponse(host).Value
            }
        End Function

        Public Shared Function FromHostAsync(host As IPAddress) As Task(Of NetworkInterfaceInfo)
            Return FromHostAsyncInternal(host)
        End Function

        Private Shared Async Function FromHostAsyncInternal(host As IPAddress) As Task(Of NetworkInterfaceInfo)
            Return New NetworkInterfaceInfo With {
                .Address = host,
